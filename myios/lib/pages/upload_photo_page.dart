...
class UploadPhotoPage extends StatefulWidget {
  ...
  UploadPhotoPage({required this.classifiedResults});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Spacer(), // Đẩy nút View History xuống cuối trang
          ElevatedButton(
            onPressed: () {
              // Navigate to FourthPage to view history
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => FourthPage(results: widget.classifiedResults),
                ),
              );
            },
            style: ElevatedButton.styleFrom(
